...
class OrdersScreen extends Component {
    ...
    getOrders(callback) {
        ...
        // let dateString =
        //     "&start_time=" +
        //     moment(new Date()).startOf("day").format("YYYY-MM-DD[T]HH:mm:ss.sss[Z]") +
        //     "&end_time=" +
        //     moment(new Date()).endOf("day").format("YYYY-MM-DD[T]HH:mm:ss.sss[Z]");

        // if (this.props.selectingMode === "day") {
        //     dateString =
        //         "&start_time=" +
        //         moment(this.props.date).startOf("day").format("YYYY-MM-DD[T]HH:mm:ss.sss[Z]") +
        //         "&end_time=" +
        //         moment(this.props.date).endOf("day").format("YYYY-MM-DD[T]HH:mm:ss.sss[Z]");
        // }
        ...
        //         moment(this.props.date).startOf("day").format("YYYY-MM-DD[T]HH:mm:ss.sss[Z]") +
        //         "&end_time=" +
        //         moment(this.props.endDate).endOf("day").format("YYYY-MM-DD[T]HH:mm:ss.sss[Z]");
        // }
            ...
            >
                <TouchableOpacity onPress={() => this.orderItemPressed(item)}>
                    ...
                    >
                        ...
                        <Text style={{ fontFamily: configjson.lightFont, marginTop: 10, flex: 1 }}>
                    ...
                    >
                        ...
                        >
                            {getPaymethodLocalized(this.props.paymethods, item.payment_method)}
                        </Text>
                        <Text
                            style={{
                                fontSize: 20,
...
export default withNavigation(connect(mapStateToProps, mapDispatchToProps)(OrdersScreen));
